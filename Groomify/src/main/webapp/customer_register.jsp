    ...
    <%@ taglib uri="jakarta.tags.core" prefix="c" %>
        <%@ include file="header.jsp" %>
            ...
            <style>
                ...
                /* ----- RIGHT PANEL - REGISTER CARD (GLASS) ----- */
                .glass-card {
                ...
                <div class="row justify-content-center align-items-stretch g-5">
                    ...
                    <div class="col-lg-6 d-flex fade-up delay-1">
                        <div class="welcome-panel w-100">
                            ...
                            <h1 class="display-3 fw-bold">Join the<br><span class="gold-text">Luxe Family</span></h1>
                            <p class="lead fs-3 mt-3" style="font-weight: 500;">Exclusive benefits<br>await you.</p>
                            ...
                            <div class="mt-4 d-flex align-items-center">
                                <div class="d-flex">
                                    ...
                                    <img src="img/user-female-2.jpg"
                                        class="rounded-circle border border-3 border-white ms-n2" width="50"
                                        height="50">
                                    <img src="img/user-male-2.jpg"
                                        class="rounded-circle border border-3 border-white ms-n2" width="50"
                                        height="50">
                                </div>
                                <span class="ms-3 text-white-50">+2,300 members</span>
                            </div>

                            <div class="mt-5 d-flex flex-column gap-3">
                                <div class="feature-badge">
                                    <i class="fas fa-gem me-3 fs-5" style="color: #d4af37;"></i>
                                    <span>10% off on all services - every visit</span>
                                </div>
                                <div class="feature-badge">
                                    <i class="fas fa-calendar-check me-3 fs-5" style="color: #d4af37;"></i>
                                    <span>Priority booking &amp; early access</span>
                                </div>
                                <div class="feature-badge">
                                    <i class="fas fa-gift me-3 fs-5" style="color: #d4af37;"></i>
                                    <span>Birthday bonus - free treatment</span>
                                </div>
                                <div class="feature-badge">
                            ...
                            <div class="mt-5 p-3 rounded-4"
                                ...
                                <div class="d-flex align-items-center">
                                    <i class="fas fa-tag fa-2x me-3" style="color: #d4af37;"></i>
                                    <div>
                                        <strong class="text-white">New member?</strong>
                                        <span class="text-white-50"> Get 20% off your first appointment!</span><br>
                                        <span class="small text-white-50">Auto-applied after registration</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-6 d-flex fade-up delay-2">
                        <div class="glass-card w-100">
                            <div class="register-header text-white text-center">
                                <i class="fas fa-user-plus fa-2x mb-3" style="color: #d4af37;"></i>
                                <h2 class="h2 fw-bold mb-0">Create Account</h2>
                                <p class="text-white-50 mb-0 mt-2">Start your pampering journey today</p>
                            </div>
                            ...
                            <div class="card-body p-4 p-xl-5">
                                ...
                                <form action="CustomerServlet" method="post">
                                    ...
                                    <div class="form-floating mb-4 fade-up delay-2">
                                        ...
                                        <label for="name"><i class="fas fa-user me-2 text-secondary"></i>Full
                                            Name</label>
                                    </div>
                                    ...
                                    <div class="form-floating mb-4 fade-up delay-3">
                                        ...
                                        <label for="email"><i class="fas fa-envelope me-2 text-secondary"></i>Email
                                            address</label>
                                    </div>
                                    ...
                                    <div class="form-floating mb-4 fade-up delay-5">
                                        ...
                                        <label for="phone"><i class="fas fa-phone me-2 text-secondary"></i>Phone
                                            Number</label>
                                    </div>

                                    <div class="form-floating mb-4 fade-up delay-6">
                                        <input class="form-control" id="area" type="text" name="area"
                                            placeholder="Area/Location" required>
                                        <label for="area"><i class="fas fa-map-marker-alt me-2 text-secondary"></i>Area
                                            / Location</label>
                                    </div>

                                    <div class="d-flex align-items-center mb-4 fade-up delay-6">
                                        ...
                                        <label class="form-check-label small text-muted" for="terms">
                                            I agree to the <a href="#" class="text-decoration-none"
                                                style="color: #d4af37;">Terms</a> and
                                            <a href="#" class="text-decoration-none" style="color: #d4af37;">Privacy
                                                Policy</a>
                                        </label>
                                    </div>

                                    <div class="d-grid gap-2 mt-3 fade-up delay-6">
                            ...
                            <div class="card-footer bg-transparent border-0 text-center py-4">
                                <div class="small text-muted">
                                    Already a member?
                                    <a href="customer_login.jsp" class="login-link fw-bold ms-1">
