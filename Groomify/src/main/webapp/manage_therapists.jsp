...
<%@ page import="dao.TherapistDAO, model.Therapist, java.util.List" %>
...
<div class="container-fluid py-4 px-lg-5">
    ...
    <div class="page-header d-flex justify-content-between align-items-center fade-up delay-1">
        <div>
            <h1 class="display-6 fw-bold mb-2">🌿 Manage Therapists</h1>
            <p class="text-dark-50 mb-0" style="font-size: 1.1rem;">
                Oversee your elite team of salon professionals and their schedules.
            </p>
        </div>
        <div>
        ...
        <div class="col-12">
            <div class="table-card p-4">
                <div class="d-flex justify-content-between align-items-center mb-4">
                    <h5 class="fw-bold mb-0"><i class="fas fa-user-md me-2" style="color: #d4af37;"></i> Staff Directory</h5>
                ...
                <div class="table-responsive rounded-3">
                    <table class="table table-hover mb-0">
                        ...
                        <tbody>
                            ...
                            %>
                                <tr>
                                    <td><span class="badge bg-light text-dark border border-secondary">#<%= t.getId() %></span></td>
                                    <td class="fw-bold text-dark">
                                        <i class="fas fa-user-circle me-2 text-secondary"></i><%= t.getName() %>
                                    </td>
                                    <td>
                                        <span class="text-warning"><i class="fas fa-star"></i></span> 
                                        <span class="fw-bold"><%= t.getRating() %></span> / 5.0
                                    </td>
                                    <td>
                                        <span class="badge-availability">
                                            <i class="fas fa-calendar-check me-1"></i> <%= t.getAvailability() %>
                                        </span>
                                    </td>
                                    <td class="text-center">
                                        <a href="TherapistServlet?action=view&id=<%= t.getId() %>" class="btn btn-sm btn-outline-primary rounded-pill px-3">
